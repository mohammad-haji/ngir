# Contributing to ngir

We would love for you to contribute to ngir and help make it ever better together! :rocket:
...
Help us keep ngir open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `ngir`.
...
* If you have a question about using ngir, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `ngir:master`.
...
we use the git commit messages to **generate the ngir change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/ngir
[stackoverflow]: https://stackoverflow.com/questions/tagged/ngir
[issues]: https://github.com/akveo/ngir/issues
[new_issue]: https://github.com/akveo/ngir/issues/new
[pulls]: https://github.com/akveo/ngir/pulls
